    ...
    <main className="flex flex-row">
      <div className="w-full h-screen flex flex-col place-content-between">
        <div>
          <img
            src={Logo}
            alt="Psycholog Krzywicka"
            className="h-16 mt-10 ml-12"
          />
        </div>
        <div className="h-1/2 ml-12 sm:mr-12 flex flex-col gap-7 place-content-center">
          ...
          <a href="/" className="text-l text-sky-500">
            <FontAwesomeIcon icon={faArrowLeft} /> Wróć na stronę główną
          </a>
        </div>
        <div className="h-20 bg-gray-100 text-gray-600 place-content-center">
          <a href="/contact" className="text-xl pl-12">
            Kontakt
          </a>
        </div>
      </div>
      <div
        className="w-3/4 bg-cover bg-center h-screen lg:hidden"
