    ...
    return (
        <main className="mt-22">
            ...
            <section id="offer" className="h-fit flex flex-col justify-center items-center py-20 gap-32">
                ...
                <InfoBox nr="2" img="familyThreapy" title="Konsultacja Rodzicielska" text="Konsultacja rodzicielskia to dedykowana przestrzeń dla rodziców i opiekunów, którzy mierzą się z wyzwaniami w wychowywaniu dzieci. 
                        Jeśli doświadczasz trudności w relacji z dzieckiem, borykasz się z problemami wychowawczymi lub chcesz lepiej zrozumieć potrzeby swojego dziecka, jestem tu po to, aby pomóc. 
                        ...
                        Moim celem jest wsparcie rodziców w stworzeniu atmosfery sprzyjającej rozwojowi dziecka i wzajemnemu porozumieniu. " price="180" time='60'/>
