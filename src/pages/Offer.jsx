    ...
    return (
        <main className="mt-22">
            ...
            <section id="offer" className="h-fit flex flex-col justify-center items-center py-20 gap-32">
                <InfoBox id="psychologicalConsultation" nr="1" img="psychologicalConsultation" title="Konsultacja Psychologiczna" text="Konsultacja psychologiczna to doraźna forma pomocy i wsparcia.  
                ...
                <InfoBox id="familyThreapy" nr="2" img="familyThreapy" title="Konsultacje Rodzicielskie" text="Konsultacje rodzicielskie to dedykowana przestrzeń dla rodziców i opiekunów, którzy mierzą się z wyzwaniami w wychowywaniu dzieci. 
                ...
                <InfoBox id="psychologicalSupport" nr="3" img="psychologicalSupport" title="Wsparcie Psychologiczne" text="Wsparcie psychologiczne to oferta skierowana do każdego, kto pragnie lepiej zrozumieć siebie i wzmocnić swoje mocne strony. 
                ...
                <InfoBox id="psychologicalTherapy" nr="4" img="psychologicalTherapy" title="Terapia Psychologiczna dla dorosłych, młodzieży i dzieci" text="Terapia psychologiczna to profesjonalna pomoc dla osób w każdym wieku, 
